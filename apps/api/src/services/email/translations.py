...
EMAIL_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "magic_login.subject": "Your Vozzrenye login link",
        "magic_login.heading": "Sign in to Vozzrenye",
        ...
        "magic_login.footer": "This link signs you in to your Vozzrenye account.",
    },
    "fr": {
    ...
    "ru": {
        ...
        "magic_login.subject": "Ссылка для входа в Платформу Воззрения",
        "magic_login.heading": "Вход в Платформу Воззрения",
        ...
        "magic_login.footer": "Эта ссылка выполнит вход в ваш аккаунт Платформы Воззрения.",
    },
    "zh": {

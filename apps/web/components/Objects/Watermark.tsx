...
function Watermark() {
    ...
    return (
        <div className='fixed bottom-8 right-8 z-50'>
            <Link href={`https://vozzrenye.pro/?source=in-app`} className="flex items-center cursor-pointer bg-white/80 backdrop-blur-lg text-gray-700 rounded-2xl p-2 light-shadow text-xs px-5 font-semibold space-x-2">

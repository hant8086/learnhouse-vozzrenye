          ...
          <div className="mt-8 flex flex-col items-center gap-6">
            ...
            {session.data?.user?.email_verified === false ? (
              ...
              <button
                ...
                className="box-border w-full inline-flex h-[44px] rounded-lg items-center justify-center vz-auth-primary bg-primary text-primary-foreground px-[15px] font-bold text-[14px] leading-none transition-all disabled:opacity-50 gap-2"
              >
                {isSubmitting ? (
            ...
            <FormLayout onSubmit={validateCode}>
              ...
              <Form.Submit asChild>
                <button
                  ...
                  className="box-border w-full inline-flex h-[44px] rounded-lg items-center justify-center vz-auth-primary bg-primary text-primary-foreground px-[15px] font-bold text-[14px] leading-none mt-2 transition-all disabled:opacity-50 gap-2"
                >
                  {isSubmitting ? (
                    <Loader2 size={18} className="animate-spin" />
                  ) : (
